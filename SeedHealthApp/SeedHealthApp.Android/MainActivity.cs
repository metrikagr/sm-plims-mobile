...
namespace SeedHealthApp.Droid
{
    ...
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            //Change Idiom based on screen size for small tablets identified as phones
            if (Xamarin.Forms.Device.Idiom == Xamarin.Forms.TargetIdiom.Phone)
            {
                ...
                var inch = System.Math.Sqrt(widhtinch * widhtinch + heightinch * heightinch);

                if (inch >= 7.0)
                {
                    Xamarin.Forms.Device.SetTargetIdiom(Xamarin.Forms.TargetIdiom.Tablet);
                }
            }
